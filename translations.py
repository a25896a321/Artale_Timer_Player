...
TRANSLATIONS = {
    'zh': {
        ...
        # hint_frame
        'hint_topmost_on':    '📌 置頂中',
        'hint_topmost_off':   '（未置頂）',
        'hint_selecting':     '選擇中...',
        'hint_calculated':    '✅ 計算完成',
        'hint_settings_open': '⚙ 設定視窗已開啟',
        ...
        'sort_base_asc':    '基礎時間排序（小→大）',
        'sort_result_desc': '推估值排序（大→小）',
        'sort_result_asc':  '推估值排序（小→大）',
        'sort_best5zones':  '顯示 5 個區間建議',
        ...
        # 快捷鍵設定視窗
        'hotkey_title':      '快捷鍵設定',
        'hotkey_col_action': '操作',
        'hotkey_col_key':    '按鍵',
        'hotkey_listening':  '請按下按鍵...',
        'hotkey_click_set':  '點擊設定',
        'hotkey_save':       '儲存',
        'hotkey_reset':      '恢復預設',
        'hotkey_close':      '關閉',
        ...
        # 贊助視窗
        'sponsor_title':   '贊助資訊',
        'sponsor_msg':     '感謝您使用 Artale Timer Player！\n作者：oo_jump\n\n如果喜歡這個工具，歡迎訂閱 YouTube 頻道支持創作！',
        'sponsor_youtube': '▶  前往 YouTube @oo_jump_game',
        'btn_close':       '關閉',
        ...
        # 訊息框
        'msg_admin_title':   '提示',
        'msg_admin_needed':  '未偵測到管理員權限。\n全域快捷鍵功能需以系統管理員身份執行程式。\n目前快捷鍵僅在視窗聚焦時有效。',
        'msg_confirm_title': '確認',
        'msg_clear_confirm': '確定要清空所有已選擇的按鈕嗎？',
        'msg_yes':           '是',
        'msg_no':            '否',
        'msg_error_title':   '錯誤',
    },
